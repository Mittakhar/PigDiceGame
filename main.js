(function(){
    ...
    gameControl.innerHTML = '<h2> Game Started </h2>';
...
game.innerHTML += "<p> Snake eyes! You Loose </p>";
...
gameData.score[gameData.index] = 0;
gameData.index ? (gameData.index = 0) : (gameData.index = 1);
game.innerHTML += `<p> One was rolled, Changing to ${gameData.players[gameData.index]}</p>`
...
document.getElementById('pass').addEventListener('click', function () {gameData.index ? (gameData.index = 0) : (gameData.index = 1);
setUpTurn();
...
function checkWinner(){
 ...
 score.innerHTML= `<h2> ${gameData.players[gameData.index]} wins with ${gameData.score[gameData.index]} points!</h2>`;
    ...
    actionArea.innerHTML = ''; 
    document.getElementById('quit').innerHTML = "Start Again?" ;
 }
